...
const dashboardContent = {
  ...
  pharmacist: { title: 'Pharmacy dashboard', subtitle: 'Keep inventory, prescriptions, and dispensing status in sync.', items: ['Medicine inventory', 'Prescriptions', 'Low-stock alerts', 'Expiry review'] },
}

const actionRoutes = {
  doctor: { "Today's appointments": '/doctor/appointments', 'Appointment management': '/doctor/appointments', 'Patients': '/doctor/appointments', 'Prescription management': '/doctor/pharmacy' },
  admin: { Appointments: '/admin/appointments', 'Hospital beds': '/patient/dashboard', 'System overview': '/admin/pharmacy' },
  pharmacist: { 'Medicine inventory': '/pharmacist/pharmacy', Prescriptions: '/pharmacist/pharmacy', 'Low-stock alerts': '/pharmacist/pharmacy', 'Expiry review': '/pharmacist/pharmacy' },
}
